#Logistic regression classification between exometabolomes of the four group of samples using principal component-1 (PC1) values from the sparse principal component analysis (sPCA) 
#Begin#
